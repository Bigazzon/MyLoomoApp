 ...
 *
 */
public class Connection extends android.os.AsyncTask<Void, String, Exception> {
    private String url;
    private int port;
    private int timeout;
    ...
    public Connection(String url, int port, int timeout, ConnectionHandler connectionHandler) {
        this.url = url;
        this.port = port;
